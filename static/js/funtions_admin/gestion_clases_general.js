document.addEventListener("DOMContentLoaded", () => {
  ...
  btnCancelar.addEventListener("click", () => {
    nombre.value=""; descripcion.value=""; tipo.value=""; nivel.value=""; instructor.value=""; capacidad.value=""; horaInicio.value=""; horaFin.value=""; sala.value=""; estado.value="true"; editId.value=""; btnCancelar.style.display="none"; btnGuardar.textContent="Guardar Clase";
  });
